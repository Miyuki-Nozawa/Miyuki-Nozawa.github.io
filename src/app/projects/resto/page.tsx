...
export default function Resto() {
  ...
  return (
    <div className="relative">
      <div
        className={`bg-red-500 w-[200px] h-[500px] fixed top-0 right-0 ${
      ...
      <div className="space-y-[20px] tracking-[.01em]">
        ...
        {/* research */}
        {/* <ProjectSection title="Research" ref={navRef}> */}
        <ProjectSection title="Research">
          ...
          <ProjectSubSection title="Understanding the Competition">
            <Paragraph>
              ...
              target users, focus, and trends to identify which features address
              specific needs.
            </Paragraph>
              ...
              <div className="space-y-[30px]">
                <div className="space-y-[10px]">
                  ...
                  <Paragraph>
                    ...
                    understand their experiences traveling to Japan and the
        ...
        <ProjectSection title="Define">
          ...
          <ProjectSubSection title="Transforming Insights into Personas">
            <Paragraph>
              ...
              process to deepen my understanding of specific users and user
              needs.
            </Paragraph>
            <div className="space-y-[30px] pb-[20px]">
              <div className="space-y-[10px]">
                ...
                <Paragraph>
                  ...
                  difficult to find and reserve restaurants popular among
                  locals. His main frustrations include{" "}
                  <b>
            ...
            <div className="space-y-[30px]">
              <div className="space-y-[10px]">
                ...
                <Paragraph>
                  ...
                  planning her first trip to Japan with friends and is excited
                  to explore Japanese cuisine. She faces challenges{" "}
                  <b>
          ...
          <ProjectSubSection title="Establishing Balanced Goals for Project Success">
            <Paragraph>
              As a step to generate ideas to solve the personas&apos; problems,
              I mapped out project goals based on the research findings.
            </Paragraph>
            <div className="py-[20px] space-y-[30px]">
              <Image
        ...
        <ProjectSection title="Ideate">
          ...
          <ProjectSubSection title="Refining Key Design Decisions">
            <Paragraph>
              I created two task flows to clarify the steps necessary for users
              to achieve specific goals and promote a user-friendly approach.
            </Paragraph>
            <div className="py-[20px] space-y-[30px]">
              <div className="space-y-[50px]">
                <div className="py-[20px] space-y-[30px]">
        ...
        <ProjectSection title="Prototype">
          <ProjectSubSection title="Exploring Ideas from Low-Fi to Mid-Fi">
            <Paragraph>
              ...
              and observations of how users prefer to search and prevent
              duplicate reservations. Starting from low-fidelity sketches, I
              developed more detailed layouts, digitizing them into mid-fidelity
              wireframes to make the designs more tangible.
            </Paragraph>
            <div className="py-[20px] space-y-[30px]">
              <div className="flex justify-between">
                <Image
          ...
          <ProjectSubSection title="Applying Branding in Hi-Fi Wireframes">
            <Paragraph>
              I incorporated all branding elements into the wireframes to create
        ...
        <ProjectSection title="Next Steps">
          <ProjectSubSection title="Learning">
            <Paragraph>
              ...
              to understand users&apos; pain points and consider how to enhance
              the user experience in order to create a better product. Since
              everyone has different travel purposes and preferences when
              choosing a restaurant, it was crucial to identify the problems
              that diverse users face and what they desire. Throughout this
              project, I came to understand the importance of user feedback and
              the necessity of collecting valuable insights through research.
            </Paragraph>
          </ProjectSubSection>
          <ProjectSubSection title="Different Approach">
            <div className="space-y-[10px]">
              ...
              <Paragraph>
                Users can explore restaurants from various angles using RESTO’s
                search function. However, to offer a more personalized search
                experience, implementing an AI-powered system is essential. This
                could involve displaying recommendations based on users&apos;
                search history and favorite lists, or adding features that
                automatically suggest similar restaurants.
              </Paragraph>
            </div>
          </ProjectSubSection>
        </ProjectSection>
